...
## Project Structure
    ...
    ├── deleterious_casino_41228  # Django project configurations
...
1. Clone this repo and `cd deleterious_casino_41228`
...
2. Clone this repo and `cd deleterious_casino_41228`
